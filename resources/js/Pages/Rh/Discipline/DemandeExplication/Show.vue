        ...
        <div class="min-height-200px">
          <div class="container pd-0">
            ...
            <div class="row mb-8 border-b">
                ...
                <a class="btn rounded-0" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fi-page-pdf"></i></a>
                <a class="btn rounded-0" data-bgcolor="#3b5998" data-color="#ffffff"><i class="icon-copy fi-print"></i></a>
                <a @click="explication" v-if="! state.isExplain" class="btn btn-sm text-white bg-black rounded-0" data-bgcolor="#3b5998" data-color="#ffffff">
                    <i class="icon-copy ion-ios-compose-outline"></i> Explication
                </a>
                <a @click="listeDemandeExplications" class="btn btn-sm text-white bg-black rounded-0" data-bgcolor="#3b5998" data-color="#ffffff">
                    <i class="icon-copy ion-ios-list-outline"></i> Liste
                  </a>
                  <a v-if="state.isExplain" @click.prevent="submit" class="btn btn-primary text-white btn-sm rounded-0" data-bgcolor="#3b5998" data-color="#ffffff">
              ...
              <form>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        v-model="demandeExplication.disciplines[0].employe.nom_emp"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Motif </label>
                      <input
                        v-model="demandeExplication.disciplines[0].motif"
                        class="form-control h-10 text-sm border-0"
                        type="text"
                        disabled
                      />
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        v-model="demandeExplication.disciplines[0].service.libelle"
                        class="form-control h-10 text-sm border-0"
                        type="text"
                        placeholder=""
                        disabled
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Postes</label>
                      <input
                        v-model="demandeExplication.disciplines[0].poste.libelle"
                        class="form-control h-10 text-sm border-0"
                        type="text"
                        placeholder=""
                        disabled
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                      v-model="demandeExplication.disciplines[0].service.employe.nom_emp"
                        class="form-control h-10 text-sm border-0"
                        type="text"
                        placeholder="Moussavou Julien"
                        disabled
                      />
                ...
                <div class="row" v-show="state.isExplain">
                    <textarea class="mb-5 textarea_editor form-control border-radius-0" placeholder="Donnez votre explication ici ..."></textarea>
                </div>
              </form>
            </div>
          </div>
...
setup() {
  ...
  mounted(){
    ...
    this.state.form.motif = this.demandeExplication.disciplines[0].motif
    this.state.form.service = this.demandeExplication.disciplines[0].service.libelle
    this.state.form.poste = this.demandeExplication.disciplines[0].poste.libelle
