        ...
        <div class="min-height-200px">
          <div class="container pd-0">
            ...
            <div class="row clearfix">
					<div v-for="demandeExplication in demandeExplications.data" :key="demandeExplication.id" class="col-lg-3 col-md-6 col-sm-12 mb-20">
						<div class="da-card">
							<div class="da-card-photo">
								<img :src="baseUrl+'vendors/images/demande_explication.jpg'" alt="">
								<div class="da-overlay da-slide-left">
									<div class="da-social">
										<ul class="clearfix">
											<li><a :href="route('demande-explication.show', demandeExplication)"><i class="icon-copy ion-eye"></i></a></li>
											<li><a href="#"><i class="icon-copy ion-ios-cloud-download-outline"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="da-card-content border">
								<h5 class="h5 mb-2">Motif : {{ demandeExplication.discipline.motif }}</h5>
								<h6 class="h6 mb-3 font-bold">Concerné : {{ demandeExplication.discipline.employe.nom_emp }}</h6>
								<p class="mb-0"></p>
							</div>
						</div>
					</div>
...
export default {
  props: ["user", "demandeExplications"],
