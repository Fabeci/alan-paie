          ...
          <div class="container pd-0">
            ...
            <div class="pd-20 card-box mb-10">
              <form>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select 
                        ...
                        @change="selectCollaborateur(state.form.collaborateur)"
                      >
                        <optgroup label="Selectionnez le collaborateur">
                ...
                <div class="btn-list">
                  <a :href="route('demande-explication.index')" class="btn btn-sm text-white bg-black rounded-0">
...
setup() {
  ...
  methods: {
    // selectCollaborateur(idCollaborateur){

    //   axios.post("/rh/discipline/demande-explication/collaborateur-service", idCollaborateur).then((res) => {
    ...
    //   axios.get("/rh/discipline/demande-explication/service-poste-service/"+idService,).then((res) => {
    ...
    submit(){
      ...
      this.$inertia.post("/rh/discipline/demande-explication", this.state.form, {
          onSuccess: () => { 
            // this.reset();
            toastr.success("La demande d'explication s'est effectuée avec succès !!");
            this.resetForm()
          },
          onError: errors => {
            this.state.errors =
