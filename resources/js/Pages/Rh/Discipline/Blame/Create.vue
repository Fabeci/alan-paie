          ...
          <div class="container pd-0">
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">blame</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="pd-20 card-box mb-10">
              <form>
                ...
                <div class="btn-list">
                  <a :href="route('blame.index')" class="btn btn-sm text-white bg-black rounded-0">
...
setup() {
  ...
  methods: {
    ...
    submit(){
      ...
      this.$inertia.post("/rh/discipline/blame", this.state.form, {
          onSuccess: () => {
            toastr.success("Le blâme a été enregistré avec succès !!");
            this.resetForm()
          },
          onError: errors => {
            this.state.errors =
