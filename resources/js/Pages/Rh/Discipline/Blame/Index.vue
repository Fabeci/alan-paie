        ...
        <div class="min-height-200px">
          <div class="container pd-0">
            ...
            <div class="row clearfix">
					<div v-for="blame in blames.data" :key="blame.id" class="col-lg-3 col-md-6 col-sm-12 mb-20">
						<div class="da-card">
							<div class="da-card-photo">
								<img :src="baseUrl+'vendors/images/blame.jpg'" alt="">
								<div class="da-overlay da-slide-left">
									<div class="da-social">
										<ul class="clearfix">
											<li><a :href="route('blame.show', blame)"><i class="icon-copy ion-eye"></i></a></li>
							...
							<div class="da-card-content border">
								<h5 class="h5 mb-2">Motif : {{ blame.discipline.motif }}</h5>
								<h6 class="h6 mb-3 font-bold">Concerné : {{ blame.discipline.employe.nom_emp }}</h6>
								<p class="mb-0"></p>
							</div>
						</div>
					</div>
