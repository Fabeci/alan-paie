        ...
        <div class="min-height-200px">
          <div class="container pd-0">
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">avertissement</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="row clearfix">
					<div v-for="avertissement in avertissements.data" :key="avertissement.id" class="col-lg-3 col-md-6 col-sm-12 mb-20">
						<div class="da-card">
							<div class="da-card-photo">
								<img :src="baseUrl+'vendors/images/avertissement.jpg'" alt="">
								<div class="da-overlay da-slide-left">
									<div class="da-social">
										<ul class="clearfix">
											<li><a :href="route('avertissement.show', avertissement)"><i class="icon-copy ion-eye"></i></a></li>
											<li><a :href="route('avertissement.pdf.preview', avertissement.id)"><i class="icon-copy ion-ios-cloud-download-outline"></i></a></li>
                      <li><a :href="route('avertissement.pdf.generate', avertissement.id)"><i class="icon-copy ion-ios-cloud-download-outline"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="da-card-content border">
								<h5 class="h5 mb-2">Motif : {{ avertissement.discipline.motif }}</h5>
								<h6 class="h6 mb-3 font-bold">Concerné : {{ avertissement.discipline.employe.nom_emp }}</h6>
								<p class="mb-0"></p>
							</div>
						</div>
					</div>
