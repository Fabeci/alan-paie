          ...
          <div class="container pd-0">
                ...
                <div class="col-md-6 col-sm-6">
                  ...
                  <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">préavis</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="pd-20 card-box mb-10">
              <form>
                ...
                <div class="btn-list">
                  <a @click="listePreavisRetraites" class="btn btn-sm text-white bg-black rounded-0">
...
export default {
  ...
  methods: {
    ...
    listePreavisRetraites() {
      this.$inertia.get("/rh/preavis-retraite", {
        onSuccess: () => {},
        onError: errors => {
          this.state.errors =
            "L'adresse email que vous avez renseignée existe déjà. Veuillez entrer une autre adresse email ou connectez-vous si vous avez déjà un compte.";
    ...
    submit() {
      ...
      data.append("dateDebut", this.state.form.dateDebut);
      data.append("dateFin", this.state.form.dateFin);

      this.$inertia.post("/rh/preavis-retraite", this.state.form, {
        onSuccess: () => {
          // this.reset();
